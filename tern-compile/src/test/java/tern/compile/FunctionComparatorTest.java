...
public class FunctionComparatorTest extends TestCase {
   ...
   "import tern.compile.FunctionComparatorTest.X;\n"+
   ...
   "import tern.compile.FunctionComparatorTest.Y;\n"+
   "import java.awt.Graphics;\n"+
   ...
   "import tern.compile.FunctionComparatorTest.Z;\n"+
   ...
   public void testPrimitiveTypeFunctions() throws Exception {
      ...
      Function x = context.getLoader().loadType("tern.compile.FunctionComparatorTest$X").getFunctions().get(0);
   ...
   public void testSingleArgument() throws Exception {
      ...
      Function y = context.getLoader().loadType("tern.compile.FunctionComparatorTest$Y").getFunctions().get(0);
   ...
   public void testMultipleArgument() throws Exception {
      ...
      Function z = context.getLoader().loadType("tern.compile.FunctionComparatorTest$Z").getFunctions().get(0);
