...
public class FunctionResolver {   
   ...
   public FunctionResolver(TypeExtractor extractor, ProxyWrapper wrapper, FunctionIndexer indexer, ClosureAdapter adapter, ThreadStack stack) {
      ...
      this.scopes = new LocalIndexer(wrapper, indexer, stack);
      this.values = new ValueIndexer(adapter, stack);
   }
