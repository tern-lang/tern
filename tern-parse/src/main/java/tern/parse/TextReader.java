...
import static tern.parse.TextCategory.BINARY;
import static tern.parse.TextCategory.CAPITAL;
import static tern.parse.TextCategory.DIGIT;
import static tern.parse.TextCategory.DOLLAR;
import static tern.parse.TextCategory.ESCAPE;
import static tern.parse.TextCategory.HEXIDECIMAL;
import static tern.parse.TextCategory.IDENTIFIER;
import static tern.parse.TextCategory.LETTER;
import static tern.parse.TextCategory.MINUS;
import static tern.parse.TextCategory.PERIOD;
import static tern.parse.TextCategory.QUOTE;
import static tern.parse.TextCategory.SPACE;
import static tern.parse.TextCategory.SPECIAL;
import static tern.parse.TextCategory.SUFFIX;
import static tern.parse.TextCategory.TEMPLATE;
