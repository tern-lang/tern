...
import static tern.parse.TokenType.BINARY;
import static tern.parse.TokenType.DECIMAL;
import static tern.parse.TokenType.HEXIDECIMAL;
import static tern.parse.TokenType.IDENTIFIER;
import static tern.parse.TokenType.LITERAL;
import static tern.parse.TokenType.QUALIFIER;
import static tern.parse.TokenType.SPACE;
import static tern.parse.TokenType.TEMPLATE;
import static tern.parse.TokenType.TEXT;
import static tern.parse.TokenType.TYPE;
